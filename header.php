...
<header class="flex items-center justify-between bg-black px-6 py-4 text-white">
  ...
  <nav class="hidden flex-1 justify-center space-x-3 md:flex">
    <a href="#" class="flex items-center gap-2 rounded-full border border-gray-600 px-4 py-1.5 text-xs font-medium transition hover:bg-white hover:text-black">
      <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A2 2 0 013 15.488V5.512a2 2 0 011.553-1.944L9 2l6 3 5.447-2.724A2 2 0 0121 4.224v9.976a2 2 0 01-1.553 1.944L15 19l-6-3z" /></svg>
      Where to Go
    </a>
    <a href="#" class="flex items-center gap-2 rounded-full border border-gray-600 px-4 py-1.5 text-xs font-medium transition hover:bg-white hover:text-black">
